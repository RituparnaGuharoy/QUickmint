...
@Component({
  selector: 'app-duplicate-class',
  templateUrl: './duplicate-class.component.html',
  styleUrls: ['./duplicate-class.component.css']
})
export class DuplicateClassComponent implements OnInit {
  scheduleForm: any;
...
let data={
  "class_title":this.create_class.class_title,
    ...
    "class_image" : this.create_class.class_image,
...
if(this.imageLink ==undefined){
  this.toastr.success("Your Class has been duplicated successfully!");
